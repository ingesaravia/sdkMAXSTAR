...
class InstantTrackerRenderer implements Renderer {
	...
	public void onSurfaceCreated(GL10 unused, EGLConfig config) {
		...
		//OBJETO A CAMBIAR LA ESTRUCTURA
	...
	private String cargarObjeto(int idObjeto){
		String nombreObjeto;
		nombreObjeto="buscando...";

		switch (idObjeto){
			case 1: nombreObjeto = "Hola";
			break;
			case 2: nombreObjeto = "chau";
		}
