...
public class InstantTrackerActivity extends ARActivity implements View.OnTouchListener, View.OnClickListener, AdapterView.OnItemSelectedListener, AdapterView.OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		miSpinner = (Spinner) findViewById(R.id.lista3D);
		miSpinner.setOnItemSelectedListener(this);

		//definimos la lista de elementos del Spinner
		listaObjetos = new String[]{"elemento 1", "elemento 2", "elemento 3"};
		//definimos el adaptador
		ArrayAdapter<String> adaptador =
				new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, listaObjetos);
	...
	public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
		...
		//INVOCAR AL RENDERER CON EL OBJETO 3D A DESPLEGAR
